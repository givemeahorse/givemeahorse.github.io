...
接下来有三个游戏，亮点核心玩法已经策划完成，但是鉴于之前的经验，打算仅做demo了。individual developer的成就感是一时绽放的高潮之花，只有保持不断学习与创新的态度，珍惜迸发的灵感，付诸于实践，坚持游戏创作的热爱，才不会凋谢。  
...
In the next three games, the core gameplay has been planned and completed, but in view of the previous experience, I intend to do only demo. The sense of achievement of individual developer is the climax flower that blooms for a while. Only by maintaining the attitude of continuous learning and innovation, cherishing the inspiration that bursts, putting it into practice, and persisting in the love of game creation, will it never fade away.
